    ...
    <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>our services</h4>
                        <h2></h2>
                        <p><h3>Business class is a travel class available on many commercial airlines and rail lines, known by brand names which vary, by airline or rail company. In the airline industry, it was originally intended as an intermediate level of service between economy class and first class, but many airlines now offer business class as the highest level of service, having eliminated first-class seating.</h3></p>
                        <p><h3>Business class is distinguished from other travel classes by the quality of seating, food, drinks, ground service and other amenities.</h3></p>
                        <p><h3>In commercial aviation, full business class is usually denoted 'J' or 'C' with schedule flexibility, but can be many other letters depending on circumstances..</h3></p>
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/img_10.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/img_76.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h2></h2>
                        <p><h3>Business class is a travel class available on many commercial airlines and rail lines, known by brand names which vary, by airline or rail company.
.</h3></p>

                        <p><h3> Offerings differ, of course, between airlines. But international business class usually includes: Priority check-in and boarding. Access to airline lounges. Fast track, or separate security lanes. Increased luggage allowance. Most international business class seats will be flat bed, or almost flat (160-170 degrees).
</h3></p>
