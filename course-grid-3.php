...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>ORFINA - the most reliable airways</title>  
...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Seat select<span class="m_1"></span></h1>
		</div>
	</div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>Find your seat map!</h4>
                        <h2>Select your seat</h2>
                        <p><h3>Seat reservation is free for first and business-class travellers on select routes operated by Air India. Preferred seat selection in the economy class is available on select routes operated by airways
Preferred seating is only open for window, aisle and middle seats in the front and middle zone of the aircraft. All seats in the rear section are currently available free of charge on our website 
Travellers can buy preferred seats up to four hours before departure.
</h3></p>
                        <p><h3>Pick your favourite seat in economy class on select Air India flights to enjoy additional comfort during your journey.</h3></p>
                        <p><h3>Paid seats do not include infant bassinets, which continue to be charge-free, subject to availability.</h3></p>
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/img_32.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/img_6.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
				
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h2>Your preferred 'window' seat</h2>
                        <p><h3>Choose a window seat, aisle seat or a seat with extra leg room starting at $70. Know about the seat fee for your preferred seat at ORFINA AIRWAYS .</h3></p>

                        <p><h3> It is mainly preferred by those flyers who love to enjoy the clouds and the picturesque views from the top or by someone who doesn’t get up frequently during the flight. It is also favoured by flyers who just want to curl up in the corner of the window seat and enjoy a good, peaceful nap.</h3></p>
                      <P><h3>the seat is assigned to you, you will find out 24 hours before the flight. So, if you paid for an aisle seat, for instance, it could be in Row 5 or Row 11. Also, the T&C clearly state that the airline reserves the right to break up your group to seat you.</h3></p>
